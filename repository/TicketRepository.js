...
class TicketRepository {
  ...
  async findByRequesterChannelConversationId(
  ...
  async updateTicket(id, updateData) {
    ...
    ticket.requestChannelConversationId =
      updateData.requestChannelConversationId ||
      ticket.requestChannelConversationId;
    ticket.techChannelConversationId =
      updateData.techChannelConversationId || ticket.techChannelConversationId;
    ticket.privateChannelConversationId =
      updateData.privateChannelConversationId ||
      ticket.privateChannelConversationId;
